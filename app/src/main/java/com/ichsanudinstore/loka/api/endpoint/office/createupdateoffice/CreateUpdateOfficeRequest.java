package com.ichsanudinstore.loka.api.endpoint.office.createupdateoffice;
 ...
 * @since Friday 8/23/2019 6:21 AM
 */
public class CreateUpdateOfficeRequest extends AuthorizationRequest {
    @SerializedName("ID")
    @Expose
